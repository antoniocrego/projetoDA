 ...
 * @param network database that stores all the information
 * @param nextMenu the page we want to change to
 */
ChangeMenu::ChangeMenu(int &currMenuPage, Network &network, int nextMenu) : MenuItem(currMenuPage, network)
{
